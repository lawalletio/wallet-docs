...
The following endpoints are provided by default:

- **`PUT <base_url>/nostr/dispatch`:** synchronous NOSTR API.
- **`PUT <base_url>/nostr/publish`:** asynchronous NOSTR API.
- **`* <base_url>/*`:** ad-hoc HTTP API endpoints.
